...
public class DriverInfoReq {
     ...
     * 姓名
     */
	@NotEmpty(groups = {AddDriverBasic.class},message = "员工姓名不能为空")
	@ApiModelProperty(value = "姓名",example = "张三")
	private String name;
    /**
     * 性别
     */
	@NotNull(groups = {AddDriverBasic.class},message = "员工性别不能为空")
     ...
     */
    @Max(value = 60)
	@NotNull(groups = {AddDriverBasic.class},message = "员工年龄不能为空或者参数不符")
	@ApiModelProperty(value = "年龄",example = "28")
	private Integer age;
    /**
     * 身份证号
     */
    @NotEmpty(groups ={AddDriverBasic.class},message = "身份证号不能为空")
    @Pattern(groups = {AddDriverBasic.class},regexp = "^[1-9]\\d{5}(18|19|([23]\\d))\\d{2}" +
     ...
     * 电话号
     */
	@NotEmpty(groups = {AddDriverBasic.class},message = "手机号码不能为空")
     ...
     * 家庭住址
     */
	@NotEmpty(groups = {AddDriverBasic.class},message = "家庭住址不能为空")
	@ApiModelProperty(value = "家庭住址",example = "河北省廊坊市广阳区万达广场")
	private String address;
	/**
	 * 所属公司
	 */
	@NotNull(groups = {AddDriverBasic.class},message = "所属公司不能为空")
